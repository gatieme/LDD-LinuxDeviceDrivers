...
### 2.1.2.4 连续内存分配器(CMA), 3.5(2012年7月发布)**
-------
...
## 2.2.2 基于页面可移动性的页面聚类(Page Clustering by Page Mobility) 2.6.23(2007年7月发布)**
-------
...
## 2.2.3 内存紧致化(Memory Compaction) 2.6.35(2010年8月发布)**
-------
...
## 2.3.2 延迟页表缓存冲刷 (Lazy-TLB flushing), 极早引入, 时间难考**
-------
...
## 2.4.2 active 与 inactive 链表拆分, 2.6.28(2008年12月)**
-------
...
## 2.4.3 再拆分出被锁页的链表, 2.6.28(2008年12月)**
-------
...
## 2.4.4 让代码文件缓存页多待一会, 2.6.31(2009年9月发布)**
-------
...
## 2.5.1 由全局的脏页门槛到每设备脏页门槛 2.6.24(2008年1月发布)**
-------
...
## 2.5.2 引入更具体扩展性的回写线程 2.6.32(2009年12月发布)**
-------
...
## 2.5.3 动态的脏页生成扼制和写回扼制算法 3.1(2011年11月发布), 3.2(2012年1月发布)**
-------
...
### 2.5.6.2 **按需预读(On-demand Readahead) 2.6.23(2007年10月发布)**
-------
...
## 2.7.2 透明大页的支持 2.6.38(2011年3月发布)**
-------
...
# 2.8 内存控制组(Memory Cgroup)支持 2.6.25(2008年4月发布)**
-------
...
## 2.9.1 **内存热插入支持 2.6.15(2006年1月发布)**
-------
...
## 2.9.2 初步的内存逻辑热拔除支持 2.6.24(2008年1月发布)**
-------
...
## 2.9.3 完善的内存逻辑热拔除支持 3.8(2013年2月发布)**
-------
...
## **2.10.1 前端接口之 CLEANCACHE 3.0(2011年7月发布)**
-------
...
## **2.10.2 前端接口之 FRONTSWAP 3.5(2012年7月发布)**
-------
...
## 2.10.5 后端之 ZSWAP 3.11(2013年9月发布)**
-------
...
## 2.11.1 NVDIMM 支持框架: libnvdimm 4.2(2015年8月30日发布)**
-------
...
## 2.12.1 页分配的调试支持 2.5(2003年7月之后发布)**
-------
...
## 2.12.3 错误注入机制 2.6.20(2007年2月发布)**
-------
...
## 2.12.4 KMEMCHECK - 内存非法访问检测工具 2.6.31(2009年9月发布)**
-------
...
## 2.12.4 KMEMLEAK - 内存泄漏检测工具 2.6.31(2009年9月发布)**
-------
...
## 2.12.5 KASan - 内核地址净化器 4.0(2015年4月发布)**
-------
...
### 2.13.1 KSM - 内存去重 2.6.32(2009年12月发布)**
-------
...
## 2.13.2 HWPoison - 内存页错误的处理 2.6.32(2009年12月发布)**
-------
...
## 2.13.3 Cross Memory Attach - 进程间快速消息传递 3.2(2012年1月发布)**
-------
