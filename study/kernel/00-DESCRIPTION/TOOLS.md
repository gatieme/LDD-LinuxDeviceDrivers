...
| 2025/07/02 | Geoffrey Thomas | [LWN, 2025/07/02, Accessing new kernel features from Python](https://lwn.net/Articles/1026749) | 每个 Linux 内核版本都有许多新功能, 其中很多都是可从用户空间访问. 不过, 通常 GNU C 库(glibc) 而访问 Linux 用户空间 API 的工具则落后于内核 发布. Geoffrey Thomas 在 [PYCON 2025](https://us.pycon.org/2025) 展示了如何通过 Python 程序在内核发布后立即使用这些新功能. | v1 ☐ | [geofft/pycon2025](https://github.com/geofft/pycon2025). |
...
[LWN, 2026/01/22, Linux Kernel Runtime Guard reaches its 1.0 release](https://lwn.net/Articles/1049295)
